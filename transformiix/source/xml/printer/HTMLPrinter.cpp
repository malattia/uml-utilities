 ...
 * $Id: HTMLPrinter.cpp,v 1.1 2001/01/07 05:41:39 jdike Exp $
 */
...
void HTMLPrinter::setOmitXMLDeclaration(MBool omitDeclaration) {
	this->omitXMLDeclaration = omitDeclaration;
    XMLPrinter::setOmitXMLDeclaration(omitDeclaration);
}
