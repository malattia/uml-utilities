 ...
 *    -- original author.
 *
 * $Id: OutputFormat.cpp,v 1.1 2001/01/07 05:41:39 jdike Exp $
 */
...
void OutputFormat::setOmitXMLDeclaration(MBool omitDeclaration) {
    this->omitXMLDeclaration = omitDeclaration;
}

MBool OutputFormat::getOmitXMLDeclaration() {
