 ...
 *    -- original author.
 *
 * $Id: OutputFormat.h,v 1.1 2001/01/07 05:41:39 jdike Exp $
 */
...
class OutputFormat {
 ...
 public:
   ...
   **/ 
   ...
   void setOmitXMLDeclaration(MBool omitDeclaration);

   MBool getOmitXMLDeclaration();
